  ...
  <section className={`${styles.yPaddings} mt-6 h-[100vh] bg-[url(/5555.svg)] bg-no-repeat bg-cover bg-right pl- lg:bg-[url(/5555.svg)] lg:bg-no-repeat lg:bg-[length:99vw_99vh]`}>
   ...
   <div className='mt-[5vh] mx-auto bg-gray-900/40 w-9/12 h-full flex flex-col items-center'>
      ...
      <div className="flex justify-center items-center flex-col relative z-10 ">
        ...
        >
          <motion.h1 className="-mt-[12vh] headingA sm:text-[4rem] lg:-mt-[22vh] text-[2.9rem] lg:text-[11rem] text-red-700 2xl:headingF 2xl:text-[14rem]">
            kiez
          </motion.h1>
          <motion.h1 className="-mt-[12vh] headingA lg:-mt-[22vh] text-[2.9rem] lg:text-[11rem] text-red-700 2xl:headingF 2xl:text-[14rem]">
            kneipe
          </motion.h1>
        </motion.div>
      </div>
