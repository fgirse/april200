...
export default function InfoBar() {
  return (
    <>
      <div className="z-[30] top-[8.5vh] fixed md:top-[10vh] lg:fixed lg:top-[15vh] mx-auto flex h-[4vh] w-[100vw] flex-row items-center justify-start gap-x-6 bg-violett-600">
