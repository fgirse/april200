...
export default function Example() {
  return (
    <section id="section-team" className="mt-[21vh]   bg-gradient-to-b from-[#1A232E] to-[#1A232E] lg:bg-[url('/ocean.jpeg')] lg:bg-[length:100vw_15vh] lg:bg-center lg:bg-no-repeat">
