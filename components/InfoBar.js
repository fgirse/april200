...
export default function InfoBar() {
  return (
    <>
      <div className="z-[30] top-[9vh] fixed md:top-[12vh] lg:fixed lg:top-[15vh] mx-auto flex h-[4vh] w-[100vw] flex-row items-center justify-start gap-x-6 lg:bg-yellow-500">
